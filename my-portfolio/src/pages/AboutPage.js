...
function AboutPage(props) {
    ...
    return (
        <div>
            ...
            <Content>
            <p>Atlanta-based Software Developer with a border-line obssesion with solving problems. Well-versed in modern programming languages
               and frameworks including: HTLM5, CSS3, JavaScript, jQuery, Progressive Web Application development, Agile Methodology, Bootstrap, React.js, Express.js, Node.js, MongoDB, MySQL, Command Line and Git.Advocate for democratizing software development and removing tech barriers to innovation.</p>
